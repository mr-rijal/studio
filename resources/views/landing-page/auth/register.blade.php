<x-guest-layout for="landing" :page="__('Register')" :sticky="false">
                                    ...
                                    <div class="panel py-4 px-2">
                                        <div class="panel vstack gap-3 w-100 sm:w-350px mx-auto text-center"
                                            ...
                                            <form class="vstack gap-2" method="POST"
                                                action="{{ route('c.register', absolute: false) }}">
                                                @csrf
                                                <input
                                                ...
                                                <input
                                                    class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30"
                                                    type="text" placeholder="{{ __('Last name') }}" name="last_name"
                                                    required value="{{ old('last_name') }}">
                                                <input
                                                    class="form-control h-48px w-full bg-white dark:bg-opacity-0 dark:text-white dark:border-gray-300 dark:border-opacity-30"
                                                    type="email" placeholder="{{ __('Your email') }}" name="email"
                                                ...
                                                <div class="hstack text-start">
                                                    <div class="form-check text-start rtl:text-end">
                                                        ...
                                                        <label for="uc_form_check_terms"
                                                            ...
                                                            {{ __('I read and accept the') }}
                                                            <a href="{{ route('c.terms') }}"
                                                                class="uc-link ltr:ms-narrow rtl:me-narrow">
                                                                {{ __('terms of use') }}
                                                            </a>.
                                                        </label>
                                                    </div>
                                                ...
                                                <button class="btn btn-primary btn-md text-white mt-2"
                                                    type="submit">{{ __('Create my account') }}</button>
                                            </form>
                                            <p>
                                                {{ __('Already have an account?') }}
                                                <a class="uc-link" href="{{ route('c.login') }}">
                                                    {{ __('Sign in') }}
                                                </a>
                                            </p>
                                        </div>
