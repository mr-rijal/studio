<x-guest-layout for="landing" :page="__('Registration Complete')" :sticky="false">
                                ...
                                <div class="panel vstack justify-center h-100 overflow-hidden">
                                    ...
                                    <div class="panel py-4 px-2">
                                        <div class="panel vstack gap-3 w-100 sm:w-350px mx-auto text-center"
                                            ...
                                            <h1 class="h4 sm:h2">{{ __('Please check your email.') }}</h1>
                                            <p class="info-box">
                                                {{ __('A link to complete your registration has been sent to your email address. If you don\'t see it, check your spam folder or request a new link. If you have any questions, please contact us at') }}
